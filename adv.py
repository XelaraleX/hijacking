...
patch_var = tf.Variable(image)
set_var_op = patch_var.assign(model.patch)
...
grad = optimizer.compute_gradients(loss, [model.patch])
#step = optimizer.minimize(loss, var_list=[patch_var])
